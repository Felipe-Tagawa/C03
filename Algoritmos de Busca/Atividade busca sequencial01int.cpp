...
int busca(dados aluno[], int tamanho, int matBusca) // Int gasta menos memória do que a struct dados, sendo mais indicada nesse caso.
{
...
int main()
{
	...
	int resultado = busca(aluno, n, matBusca); // Retornando a função busca para ter a posição i para resultado.
